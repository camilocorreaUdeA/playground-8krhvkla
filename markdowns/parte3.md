...
int main()
{
	...
	FooClass fooObj4(fooObj2); // ¡Bien, C++ si declara un constructor de copia implicito!
	FooClass fooObj5 = fooObj4; // ¡También está bien en este caso (C++ si declara un constructor de copia implicito)!
	return 0;
}
```
